export const ERROR_MESSAGES = {
  PROJECT: {
    ...
    NO_N2A_CONFIG: "N2A config file not found in the current directory",
  },
  CONFIG: {
    LOAD_FAILED: "Failed to load N2A config",
    CREATE_FAILED: "Failed to create N2A config",
    NOT_FOUND: "N2A config file not found",
    PARSE_ERROR: "N2A config file parse error",
    WRITE_ERROR: "N2A config file write error",
  },
  DEV_SERVER: {
